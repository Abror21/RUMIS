...
{
    public sealed class ApplicationResourceServiceFake : IApplicationResourceService
    {
        public IQueryable<ApplicationResource> ApplicationResources { get; set; } = new TestAsyncEnumerable<ApplicationResource>(new List<ApplicationResource>());
