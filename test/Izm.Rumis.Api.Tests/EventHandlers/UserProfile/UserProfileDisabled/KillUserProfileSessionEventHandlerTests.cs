...
namespace Izm.Rumis.Api.Tests.EventHandlers.UserProfile.UserProfileDisabled
{
    public sealed class KillUserProfileSessionEventHandlerTests
    {
        private readonly UserProfileDisabledEvent notification = new UserProfileDisabledEvent(Guid.NewGuid());
