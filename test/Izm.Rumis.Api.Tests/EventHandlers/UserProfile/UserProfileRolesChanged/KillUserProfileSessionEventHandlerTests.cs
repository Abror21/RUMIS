using Izm.Rumis.Api.EventHandlers.UserProfile.UserProfileRolesChanged;
...
namespace Izm.Rumis.Api.Tests.EventHandlers.UserProfile.UserProfileRolesChanged
{
    public sealed class KillUserProfileSessionEventHandlerTests
    {
        private readonly UserProfileRolesChangedEvent notification = new UserProfileRolesChangedEvent(Guid.NewGuid());
