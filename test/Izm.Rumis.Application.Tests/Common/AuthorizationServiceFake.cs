...
namespace Izm.Rumis.Application.Tests.Common
{
    internal sealed class AuthorizationServiceFake : IAuthorizationService
    {
        ...
        public int? AuthorizeEducationalInstitutionCalledWith { get; set; } = null;
        public string AuthorizeAsyncCalledWith { get; set; } = null;
        public string AuthorizeAsyncRequestedPersonInstitutionCalledWith { get; set; } = null;
        ...
        {
            AuthorizeEducationalInstitutionCalledWith = educationalInstitutionId;
        ...
        {
            AuthorizeAsyncRequestedPersonInstitutionCalledWith = privatePersonalIdentifier + educationalIsntitutionCode;
