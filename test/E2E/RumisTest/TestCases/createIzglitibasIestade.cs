...
namespace RumisTest
{
    #region StudyPlan
    [TestClass]
    public class createIzglitibasIestade : BaseRunner
    {
        String XPath;
        String textToElement;
        String errorMessage;
        String currentSolisDesc;
        String testCaseDesc = "Testa scenārijs: Pieteikumu izveide, kad laukā \"Resursa pieteicējs\" vērtība tiek norādīta \"Izglītības iestāde\" (createIzglitojamais.cs).";
        ...
        public void runTest()
        {
            ...
            ServicesPage.clearCreatedRecordsFromDBIzglitibasIestade();
            ...
            XPath = "//div[text()='Izglītības iestāde']";
            ...
            XPath = "//div[@id='6edb243c-efb9-42f0-bda0-51d8becc208c']";
            errorMessage = "\"Windows portatīvais dators\" opciju iepriekš atvērtajā izvēlnē. " + currentSolisDesc + " " + testCaseDesc;
            ServicesPage.clickToElement(XPath, errorMessage);
