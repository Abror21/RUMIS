...
namespace RumisTest
{
    #region StudyPlan
    [TestClass]
    public class createVecaksAizbildnis : BaseRunner
    {
        String XPath;
        String textToElement;
        String errorMessage;
        String currentSolisDesc;
        String testCaseDesc = "Testa scenārijs: Pieteikumu izveide, kad laukā \"Resursa pieteicējs\" vērtība tiek norādīta \"Vecāks/aizbildnis\" (createVecaksAizbildnis.cs).";
        ...
        public void runTest()
        {
            ...
            ServicesPage.clearCreatedRecordsFromDBVecaksAizbildnis();
            ...
            W("(7) Uzspiež uz \"Rīgas 1. Kristīgā pamatskola\" izvelnes opciju.\n");
            XPath = "//div[text()='Rīgas 1. Kristīgā pamatskola']";
            errorMessage = "\"Rīgas 1. Kristīgā pamatskola\" izvelnes lauku. " + currentSolisDesc + " " + testCaseDesc;
            ServicesPage.clickToElement(XPath, errorMessage);
            ...
            currentSolisDesc = "5.Solis (11-34): Aizpildīt un saglabāt jaunu pieteikumu atbilstoši scenārija pieprasījumam (Resursa pieteicējs: Vecāks/aizbildnis).";
            W(currentSolisDesc);
            ...
            W("(12) Uzspiež uz \"Vecāks/aizbildnis\" opciju iepriekš atvērtajā izvēlnē.\n");
            XPath = "//div[text()='Vecāks/aizbildnis']";
            errorMessage = "\"Vecāks/aizbildnis\" opciju iepriekš atvērtajā izvēlnē. " + currentSolisDesc + " " + testCaseDesc;
            ServicesPage.clickToElement(XPath, errorMessage);

            W("(13) Ievada datus \"Pieteicēja personas kods\" laukā.\n");
            XPath = "//input[@id='applicantPersonalCode']";
            textToElement = "00000000000";
            errorMessage = "\"Pieteicēja personas kods\" laukā, jauna pieteikuma izveides formā. " + currentSolisDesc + " " + testCaseDesc;
            ServicesPage.fillElementWithText(XPath, textToElement, errorMessage);

            W("(14) Ievada datus \"Pieteicēja vārds\" laukā.\n");
            XPath = "//input[@id='applicantName']";
            textToElement = "Admin";
            errorMessage = "\"Pieteicēja vārds\" laukā. " + currentSolisDesc + " " + testCaseDesc;
            ServicesPage.fillElementWithText(XPath, textToElement, errorMessage);

            W("(15) Ievada datus \"Pieteicēja uzvārds\" laukā.\n");
            XPath = "//input[@id='applicantSurname']";
            textToElement = "Admin";
            errorMessage = "\"Pieteicēja uzvārds\" laukā. " + currentSolisDesc + " " + testCaseDesc;
            ServicesPage.fillElementWithText(XPath, textToElement, errorMessage);

            W("(16) Uzspiež uz \"Izgūt datus\" pogu.\n");
            XPath = "//button[contains(., 'Izgūt datus')]";
            errorMessage = "\"Izgūt datus\" pogu. " + currentSolisDesc + " " + testCaseDesc;
            ServicesPage.clickToElement(XPath, errorMessage);

            W("(17) Uzspiež uz \"Resursa lietotājs\" izvelnes lauka.\n");
            XPath = "//input[@id='resourceUser']//parent::span";
            errorMessage = "\"Resursa lietotājs\" izvelnes lauka. " + currentSolisDesc + " " + testCaseDesc;
            ServicesPage.clickToElement(XPath, errorMessage);

            W("(18) Uzspiež uz \"DĒLS ADMIN (p.k. 32472941017)\" opciju iepriekš atvērtajā izvēlnē.\n");
            XPath = "//div[text()='DĒLS ADMIN (p.k. 32472941017)']";
            errorMessage = "\"DĒLS ADMIN (p.k. 32472941017)\" opciju iepriekš atvērtajā izvēlnē. " + currentSolisDesc + " " + testCaseDesc;
            ServicesPage.clickToElement(XPath, errorMessage);

            W("(19) Uzspiež uz \"Atbilst\" opciju izvelnei (Vai izglītojamais atbilst kādai sociālai atbalsta grupai?).\n");
            ...
            W("(20) Uzspiež uz \"Invaliditāte\" opciju izvelnei (Norādiet vismaz vienu sociālā atbalsta grupu).\n");
            ...
            W("(21) Uzspiež jeb atzīmē ka lietotājs ir informēts utt.\n");
            ...
            W("(32) Izvēlās .docx failu norādot tā atrašanas vietu (Atrašanas vieta ir iekš šā automātiskā testa projekta direktorijas)");
            ...
            W("(33) Uzspiež uz \"Saglabāt\" pogu.\n");
            XPath = "//button[@type='submit']";
            errorMessage = "\"Saglabāt\" pogu. " + currentSolisDesc + " " + testCaseDesc;
            ServicesPage.clickToElement(XPath, errorMessage);

            W("(34) Pārbauda vai tika veiksmīgi saglabāts izveidotais pieteikums.");
            ...
            currentSolisDesc = "6.Solis (35-37): Izrakstīties no RUMIS vides.";
            W(currentSolisDesc);
            W("(35) Uzspiež profila bildi lai atvērtu izvēlni.\n");
            ...
            W("(36) Uzspiež uz \"Iziet\" opciju iepriekš atvērtajā izvēlnē.\n");
            XPath = "//button[.='Iziet']";
            errorMessage = "\"Iziet\" opciju iepriekš atvērtajā izvēlnē. " + currentSolisDesc + " " + testCaseDesc;
            ServicesPage.clickToElement(XPath, errorMessage);

            W("(37) Pārbauda vai tika veiksmīgi izpildīta atslēgšanās no RUMIS vides.");
