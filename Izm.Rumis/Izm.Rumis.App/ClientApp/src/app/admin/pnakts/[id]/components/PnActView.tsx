                                ...
                                <div className="flex flex-col gap-y-6">
                                    <div className="bg-white rounded-lg p-6">
                                        ...
                                        <div className="grid grid-cols-[0.8fr,1.2fr] py-3 border-b border-gray">
                                          ...
                                          <div><Link href={`/admin/application/${data.application.id}`}>{data.application.applicationNumber}</Link>&#160;&#160;({data.application.applicationDate && dayjs(data.application.applicationDate).format(dateFormat)})</div>
                                        </div>
                                    </div>
                                ...
                                {/* P/N akta saskaņotājs */}
                                    <div className="bg-white rounded-lg p-6">
                                      ...
                                      <div className="grid grid-cols-[0.8fr,1.2fr] py-3">
                                        ...
                                        <div>Administrators Jaunākais</div>
                                      </div>
