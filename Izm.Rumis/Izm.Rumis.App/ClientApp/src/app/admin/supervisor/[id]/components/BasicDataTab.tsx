        ...
        <div className="grid grid-cols-2 gap-4">
            <div>
                ...
                <div className="flex justify-between pl-2">
                    <div><b>Kopā:</b></div>
                    <div>
                        <Link href={allResourcesLink}>{data.activeResources}</Link>
                    </div>
                </div>
                <div className="flex justify-between pl-2">
                    <div>Izsniegti individuālai lietošanai:</div>
                    <div><Link href={inUsePersonallyResourcesLink}>{data.resourcesInUsePersonally}</Link></div>
                </div>
                <div className="flex justify-between pl-2">
                    <div>Lietošanā iestāde:</div>
                    <div><Link href={inUseEducationallyResourcesLink}>{data.resourcesInUseEducationally}</Link></div>
                </div>
            </div>
            <div>
                ...
                <div className="flex justify-between pl-2">
                    <div><b>Kopā:</b></div>
                    <div><Link href={'/admin/applications'}>{data.applications}</Link></div>
                </div>
                <div className="flex justify-between pl-2">
                    <div>Apstiprināts:</div>
                    <div><Link href={applicationsAcceptedLink}>{data.applicationsAccepted}</Link></div>
                </div>
                <div className="flex justify-between pl-2">
                    <div>Izskatīšanā:</div>
                    <div><Link href={applicationsAwaitingLink}>{data.applicationsAwaitingResources}</Link></div>
                </div>
                <div className="flex justify-between pl-2">
                    <div>Atlikta izskatīšana:</div>
                    <div><Link href={applicationsPostponedLink}>{data.applicationsPostponed}</Link></div>
                </div>
            </div>
            <div>
                ...
                <div className="flex justify-between pl-2">
                    <div><b>Kopā:</b></div>
                    <div><Link href={allEduLink}>{data.educationalInstitutions}</Link></div>
                </div>
                <div className="flex justify-between pl-2">
                    <div>Aktīvas:</div>
                    <div><Link href={activeEduLink}>{data.activeEducationalInstitutions}</Link></div>
                </div>
            </div>
            <div>
                ...
                <div className="flex justify-between pl-2">
                    ...
                    <div><Link href={countryDocumentTemplates}>{data.countryDocumentTemplates}</Link></div>
                </div>
                <div className="flex justify-between pl-2">
                    <div>Vadošās iestādes veidnes:</div>
                    <div><Link href={countryDocumentTemplates}>{data.educationalInstitutionsDocumentTemplates}</Link></div>
                </div>
                <div className="flex justify-between pl-2">
                    <div>Vadošās iestādes saites:</div>
                    <div><Link href={countryDocumentTemplates}>{data.educationalInstitutionsDocumentLinks}</Link></div>
                </div>
            </div>
            <div>
                ...
                <div className="flex justify-between pl-2">
                    <div><b>Kopā:</b></div>
                    <div><Link href={'/admin/users'}>2</Link></div>
                </div>
                <div className="flex justify-between pl-2">
                    <div>Aktīvas:</div>
                    <div><Link href={'/admin/users'}>2</Link></div>
