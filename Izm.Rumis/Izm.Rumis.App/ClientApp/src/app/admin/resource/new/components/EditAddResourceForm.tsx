            ...
            <div className='w-1/2 flex flex-col bg-white rounded p-6'>
              ...
              <div>
                ...
                <Form.Item
                  label="Nosaukums"
                  name="resourceName"
                  rules={[{ required: true , message: 'Nosaukums ir obligāts lauks'}]}
                >
                  <Input placeholder="Ražotāja nosaukums" />
                </Form.Item>
                <Form.Item
                  label="Ražotājs"
                  name="manufacturerId"
                ...
                <Form.Item
                  label="Resursa numurs"
                  name="resourceNumber"
                  rules={[{ required: true , message: 'Resursa numurs ir obligāts lauks'}]}
                >
                  <Input />
                </Form.Item>
                <Form.Item
                  label="Modeļa identifikators"
                  name="modelIdentifier"
                >
                  <Input placeholder='Modeļa identifikators' />
                </Form.Item>
                <Form.Item
                  name="modelNameId"
                  label="Modelis"
                  rules={[{ required: true , message: 'Modelis ir obligāts lauks'}]}
                >
                  <SearchSelectInput
                ...
                <Form.Item
                  ...
                  name="serialNumber"
                  rules={[{ required: true , message: 'Sērijas numurs ir obligāts lauks'}]}
                >
                ...
                <Form.Item
                  ...
                  rules={[{ required: true , message: 'Inventāra Nr. ir obligāts lauks'}]}
                >
