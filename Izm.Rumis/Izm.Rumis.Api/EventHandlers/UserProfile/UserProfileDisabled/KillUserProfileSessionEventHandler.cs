...
{
    public sealed class KillUserProfileSessionEventHandler : INotificationHandler<UserProfileDisabledEvent>
    {
        ...
        public Task Handle(UserProfileDisabledEvent notification, CancellationToken cancellationToken)
        {
            var data = new UserProfileSessionKillData
            {
                Event = nameof(UserProfileDisabledEvent),
